...
const md = `
Effective date: 07/25/2021

1. **Introduction**

  Welcome to **Graftini.com**.

  Graftini.com (“us”, “we”, or “our”) operates https://www.graftini.com (hereinafter referred to as “**Service**”).

  Our Privacy Policy governs your visit to https://www.graftini.com, and explains how we collect, safeguard and disclose information that results from your use of our Service.
...
2. **Definitions**
  ...
  **SERVICE **means the https://www.graftini.com website operated by Graftini.com.
...
5. **Use of Data**
  ...
  Graftini.com uses the collected data for various purposes:
...
7. **Transfer of Data**
  ...
  Graftini.com will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.
...
10. **Your Data Protection Rights Under General Data Protection Regulation (GDPR)**
  ...
  If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at team@graftini.com.
...
11. **Your Data Protection Rights under the California Privacy Protection Act (CalOPPA)**
  ...
  According to CalOPPA we agree to the following:
    ...
    4. users are able to change their personal information by emailing us at team@graftini.com.
...
14. **CI/CD tools**
  ...
  **Google Cloud Build**
  ...
  Google Cloud Build is provided by Alphabet Inc.

  Google Cloud Build is a CI/CD to build and deploy software.

  For more information on what data Google Cloud Build collects for what purpose and how the protection of the data is ensured, please visit Google Cloud Privacy Policy page: [https://cloud.google.com/security/privacy](https://cloud.google.com/security/privacy).

  **Vercel**

  Vercel is provided by Vercel Inc.

  Vercel is a hosting platform that we use to build and host the websites that you deploy.

  For more information on what data Vercel collects for what purpose and how the protection of the data is ensured, please visit Vercel Privacy Policy page: [https://vercel.com/legal/privacy-policy](https://vercel.com/legal/privacy-policy).
...
15. **Payments**
  ...
  **Paddle**
  ...
  Their Privacy Policy can be viewed [https://paddle.com/privacy/](https://paddle.com/privacy/).
