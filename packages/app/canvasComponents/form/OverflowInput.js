...
const options = [
  { value: 'visible', icon: <EyeOpenIcon width={20} height={20} />, label: 'Show' },
  { value: 'hidden', icon: <EyeClosedIcon width={20} height={20} />, label: 'Hide' },
  {
    value: 'scroll',
    icon: <AllSidesIcon width={20} height={20} />,
    label: 'Scroll',
  },
  { value: 'auto', icon: <MagicWandIcon width={20} height={20} />, label: 'Auto' },
];
